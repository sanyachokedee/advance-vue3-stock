<template>
	<footer class="container px-4 py-6 mx-auto mt-6">
		<hr class="mb-6" />
		<div
			class="flex flex-col justify-between mb-6 space-y-6 md:flex-row md:space-y-0"
		>
			<div class="flex-1">
			...
			<div class="flex flex-1 space-x-6 font-medium md:justify-center">
				<router-link to="/features" class="transition-colors duration-200 hover:text-emerald-700">Features</router-link>
					<router-link to="/services" class="transition-colors duration-200 hover:text-emerald-700">Services</router-link>
					<router-link to="/testimonials" class="transition-colors duration-200 hover:text-emerald-700">Testimoials</router-link>
		...
		<div
			class="flex flex-col space-y-2 text-xs text-gray-500 md:flex-row md:justify-center md:space-y-0 md:space-x-3"
		>
			<p>Copyright © 2021 Amiso. All rights reserved.</p>
			<p>
				Hand illustration by
				<a
